      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          ...
          <h2 class="panel-title"><b>Dirección: </b><br>${usuinfo.direccion}<br><br></h2>
           ...
           <p><a class="btn btn-primary" id="botones" href="formUsuario.jsp" role="button">Rellenar Perfil  &raquo;</a></p>
           <p><a class="btn btn-primary" id="botones" href="mod-perfil?action=modificar&id=${usuario.id}" role="button">Modificar perfil &raquo;</a></p>
      </div>
