    ...
    <div class="container">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Rellenar perfil</h3>
        </div>
        <div class="panel-body">
         <form action="info-perfil" method="post">
            <div class="form-group">
              <label for="nombre">Nombre</label>
              <input type="text" class="form-control" name="nombre" required id="nombre" value="" value="" placeholder="">
            </div>                   
            <div class="form-group">
              <label for="email">Correo electrónico</label>
              <input type="text" class="form-control" name="email" id="email" required rows="3" value="" placeholder="">
            </div>
            <div class="form-group">
              <label for="direccion">Escriba su dirección</label>
              <input type="text" class="form-control" name="direccion" id="direccion" rows="4" value="" placeholder="">
            </div>
              <div class="form-group">
              <label for="telefono">Teléfono</label>
              <input type="text" class="form-control" name="telefono" id="telefono" rows="4" value="" placeholder="">
              </div>
              <div class="form-group">
