    ...
    <div class="container">
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          <h2 class="panel-title"><b>Username</b><br> ${usuario.user}<br><br></h2>
          
          <h2 class="panel-title"><b>Perfil</b><br>${usuario.perfil}<br><br></h2>
          
          <h2 class="panel-title"><b>Código de recuperación de Contraseña</b><br>${usuario.codRecuperacion}<br><br></h2>
