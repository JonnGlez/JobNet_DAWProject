            ...
            <tbody>     
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <c:if test="${usuario.id > 0}">
                       <c:set var = "perfil1" scope = "session" value = "Empresa"/>
                        <c:if  test="${(usuario.perfil.equals(perfil1))}" >
                    <a class="btn btn-default" href="solicitud?action=consultar&idVacante=${vacante.id}&perfil=${usuario.perfil}" role="button">Solicitudes</a>                         
                        </c:if>
                    </c:if>
                    </td>  
